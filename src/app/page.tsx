    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-100 flex flex-col md:flex-row justify-center items-center p-6 md:p-16 gap-12 md:gap-24 font-sans text-slate-900">
      ...
      <div className="w-full max-w-xl space-y-6 flex-1">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          {/* BASIC PLAN */}
          <div className="bg-white border-2 border-emerald-400 rounded-2xl shadow-lg relative overflow-hidden group hover:-translate-y-1 transition duration-300 flex flex-col">
            ...
            <div className="p-5 flex flex-col flex-1">
              <div className="text-2xl font-black text-slate-900 mb-3">₹1,143<span className="text-xs text-slate-500 font-medium">/yr</span></div>
              <ul className="text-xs text-slate-600 space-y-2 flex-1">
                <li className="flex items-center gap-2"><CheckCircle2 className="w-4 h-4 text-emerald-500 shrink-0" /> Single User Access</li>
                <li className="flex items-center gap-2"><CheckCircle2 className="w-4 h-4 text-emerald-500 shrink-0" /> Basic GST Billing</li>
                <li className="flex items-center gap-2"><CheckCircle2 className="w-4 h-4 text-emerald-500 shrink-0" /> Simple Inventory</li>
              </ul>
              <a
                href="https://wa.me/919857640014?text=Hi,%20I%27m%20interested%20in%20buying%20the%20BASIC%20Plan%20(₹1,143/yr)%20for%20my%20business."
                target="_blank"
                rel="noopener noreferrer"
                className="mt-5 inline-flex items-center justify-center gap-2 w-full px-4 py-2.5 bg-[#25D366] hover:bg-[#1ebd5a] active:scale-95 text-white font-bold text-xs rounded-xl shadow-md shadow-[#25D366]/30 transition"
              >
          ...
          {/* PRO PLAN */}
          <div className="bg-gradient-to-b from-indigo-50 to-white border-2 border-indigo-500 rounded-2xl shadow-xl shadow-indigo-200/50 relative overflow-hidden group hover:-translate-y-1 transition duration-300 flex flex-col">
            <div className="bg-indigo-600 text-white px-4 py-2.5 font-black uppercase tracking-widest text-xs flex items-center justify-center gap-1.5 shadow-sm z-20">
              <Zap className="w-4 h-4" /> Pro Plan
            </div>
            <div className="absolute top-10 right-0 p-4 opacity-10 group-hover:scale-125 transition duration-500 z-0"><Zap className="w-24 h-24 text-indigo-600" /></div>
            <div className="p-5 relative z-10 flex flex-col flex-1">
              <div className="text-3xl font-black text-indigo-900 mb-3">₹1,843<span className="text-xs text-indigo-500 font-medium">/yr</span></div>
              <ul className="text-xs text-slate-700 space-y-2 flex-1 font-medium">
                <li className="flex items-center gap-2"><CheckCircle2 className="w-4 h-4 text-indigo-600 shrink-0" /> Multi-branch POS</li>
                <li className="flex items-center gap-2"><CheckCircle2 className="w-4 h-4 text-indigo-600 shrink-0" /> Advanced Reports</li>
                <li className="flex items-center gap-2"><CheckCircle2 className="w-4 h-4 text-indigo-600 shrink-0" /> E-Way & Batches</li>
              </ul>
              <a
                href="https://wa.me/919857640014?text=Hi,%20I%27m%20interested%20in%20buying%20the%20PRO%20Plan%20(₹1,843/yr)%20for%20my%20business."
                target="_blank"
                rel="noopener noreferrer"
                className="mt-5 inline-flex items-center justify-center gap-2 w-full px-4 py-2.5 bg-[#25D366] hover:bg-[#1ebd5a] active:scale-95 text-white font-bold text-xs rounded-xl shadow-md shadow-[#25D366]/30 transition"
              >
